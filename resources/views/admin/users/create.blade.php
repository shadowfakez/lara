                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <div class="bg-white">
                                <nav class="flex flex-col sm:flex-row">
                                    <button>
                                        <a href="{{ route('admin.home') }}" class="text-gray-600 py-4 px-6 block hover:text-blue-500 focus:outline-none ">
                                            Dashboard</a>
                                    </button>
                                    <button>
                                        <a class="text-gray-600 py-4 px-6 block hover:text-blue-500 focus:outline-none" href="{{ route('users.index') }}">
                                            Users</a>
                                    </button>
                                    <button>
                                        <a href="{{ route('users.create') }}" class="text-gray-600 py-4 px-6 block hover:text-blue-500 focus:outline-none text-blue-500 border-b-2 font-medium border-blue-500">
                                            Create User</a>
                                    </button>
                                </nav>
                            </div>
